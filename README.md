...
| S17     | Robustness test for the effect the generation interval.                                                                                                | [generation_interval](./notebooks/supplementary/robustness/generation_interval.ipynb)                |
| S18     | Robustness test for the remaining priors not studied in the previous figures                                                                           | [other_priors](./notebooks/supplementary/robustness/other_priors.ipynb)                              |
