...
#$ -pe mvapich2-zal 32
#$ -cwd
#$ -o $HOME/repositories/covid19_soccer/scripts/run_on_cluster/log/output-soccer-revision_robustness
#$ -e $HOME/repositories/covid19_soccer/scripts/run_on_cluster/log/errors-soccer-revision_robustness
#$ -t 1-20
...
python3 -u ./cluster_runs_gender_revision_robustness.py -i $SGE_TASK_ID
